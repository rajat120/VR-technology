		...
		<div>
			<div className="footer">
				...
				<div className="class5">
					<h3>SUBSCRIBE</h3>
					<p>send us learnofi-ed news events and excluive offers</p>
					<form>
						<label>Email:</label>
					...
					>
						<h5>Privacy accessibility terms </h5>
